...
__all__ = ['extract_subroutine', 'extract_marked_subroutines']


def extract_subroutine(region, name, imports, intent_map=None):
    """
    ...
    # Filter out derived-type variables from declarations
    region_routine_variables = {
...
def extract_marked_subroutines(routine):
    ...
    routine : :any:`Subroutine`
        The subroutine in from which to extract marked subroutines.
    ...
    with pragma_regions_attached(routine):
        with dataflow_analysis_attached(routine):
            for region in FindNodes(PragmaRegion).visit(routine.body):
                ...
                call, region_routine = extract_subroutine(region, name, imports, intent_map=parameters)
