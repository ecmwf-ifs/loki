...
from loki.transformations.genai.fortran2acc import AccInsertionTransformation
from loki.transformations.genai.fortran2python import Fortran2PythonTransformation
from loki.transformations.genai.python2dace import DaceOptimisationTransformation
import pytest
...
subroutine convect_satmixratio(xalpw, xbetaw, xgamw, &
    ...
    fsub = Subroutine.from_source(fortran_code, preprocess=True)
    AccT = AccInsertionTransformation()
    gen_fsub = AccT.transform_subroutine(fsub)
...
def test_daceoptimisation_transformation():
...
subroutine convect_satmixratio(xalpw, xbetaw, xgamw, &
    ...
    fsub = Subroutine.from_source(fortran_code, preprocess=True)
    DaceOptT = DaceOptimisationTransformation()
    gen_fsub = DaceOptT.transform_subroutine(fsub)
