...
__all__ = [
    ...
    'do_remove_unused_imports', 'RemoveImportsTransformer'
]
...
class RemoveImportsTransformer(Transformer):
    """
    ...
    def __init__(self, symbols, **kwargs):
        ...
        self.symbol_names = tuple(str(s.name).lower() for s in self.symbols)
