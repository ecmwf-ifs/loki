...
__all__ = [
    ...
    'get_local_arrays', 'check_routine_sequential', 'remap_variables'
]
...
def remap_variables(routine, variables):
    """
    'Remap' variables if variable was initialized with another var/value.
