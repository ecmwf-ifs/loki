...
"""
Loki head script for source-to-source transformation of ECMWF
physics into Maxeler dataflow computing format.
"""
...
@click.option('--mode', '-m', default='maxeler-sca',
              type=click.Choice(['maxeler_sca', 'maxeler']))
