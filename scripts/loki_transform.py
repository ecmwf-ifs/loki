...
@click.option('--mode', '-m', default='idem',
              type=click.Choice(
                  ['idem', 'c', 'scc-cpu', 'idem-stack', 'sca', 'claw', 'scc', 'scc-hoist', 'scc-stack',
                   ...
                   'c-hoist', 'cuf-dynamic', 'hip-parametrise', 'hip-hoist']
              ),
...
def convert(
    ...
    if 'scc' in mode or mode in ['cuf-parametrise-new', 'cuf-hoist-new', 'c-parametrise', 'c-hoist', 'hip-parametrise', 'hip-hoist']:
    ...
    if mode not in ['c-parametrise', 'c-hoist', 'hip-parametrise', 'hip-hoist']:
    ...
    if mode in ['scc', 'scc-hoist', 'scc-stack', 'scc-cpu', 'cuf-parametrise-new', 'cuf-hoist-new', 'c-parametrise', 'c-hoist', 'hip-parametrise', 'hip-hoist']:
    ...
    if mode == 'cuf-parametrise' or mode == "cuf-parametrise-new" or mode in ['c-parametrise', 'hip-parametrise']:
